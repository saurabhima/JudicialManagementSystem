        ...
        if($cin!=null)
        {
            ...
            echo '
                <div class="container">
                    ...
                    <form class="well form-horizontal" action="process_registrar_comments_db.php" method="post"  id="contact_form" name="contact_form">
                        <fieldset>
                
                            <!-- Form Name -->
                            <legend align="center">Registrar Case Entry</legend>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"></label>
                                <div class="col-md-4">
                                    <button type="submit" name="process_registrar_comments" class="btn btn-warning" >Process Comments<span class="glyphicon glyphicon-send"></span></button>
                                </div>
                            </div>
