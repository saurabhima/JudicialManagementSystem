        ...
        if(isset($_POST['submit'])){
            ...
            display:none;
                ...
                <div class="container">
                    ...
                    <form class="well form-horizontal" action="process_registrar_close_case_db.php" method="post"  id="contact_form" name="contact_form">
                        <fieldset>
                
                            <!-- Form Name -->
                            <legend style="text-align:center">Registrar Close Case</legend>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Case Status</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                                        <input name="case_status" placeholder="Case Status" readonly value="' . $case_status . '" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Presiding Judge</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                                        <input name="presiding_judge" placeholder="" readonly value="' . $presiding_judge . '" class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                        <textarea class="form-control" name="registrar_comments"  placeholder="Registrar\'s Comments"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"></label>
                                <div class="col-md-4">
                                    <button type="submit" name="process_registrar_comments" class="btn btn-warning" >Close Case<span class="glyphicon glyphicon-send"></span></button>
                                </div>
                            </div>
            ...
            <h4>The Requested CIN could not be found</h4>
